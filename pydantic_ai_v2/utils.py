...
def get_cash_balance(as_of_date: Union[str, datetime]) -> float:
    ...
    print(f"FUNC (get_cash_balance) as of '{as_of_date}'")
...
def generate_financial_report(as_of_date: Union[str, datetime]) -> Dict:
    ...
    print(f"FUNC (generate_financial_report) as of '{as_of_date}'")
...
def search_quote_history(search_terms: List[str], limit: int = 5) -> List[Dict]:
    ...
    print(f"FUNC (search_quote_history) for '{', '.join(search_terms)}'")
...
def evaluate_purchase_requirement(item_name:str, quantity_required:int, input_date_str:str)->str:
    ...
    #//////////////// CONTROL \\\\\\\\\\\\\\\\\
    #print_rich(message, color="orange3")
